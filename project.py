...
def compute_all():
  ...
  # Legends : 
  # Current Road Width = rws
  # Next Road Width = rwn
  # Current Road Density  = rds
  # Next Road Density = rdn

  # Rules : 
  # If rws = wide, rwn = narrow/wide, dan rds = not/little crowded, then green_dur = awhile
  ...
  # If rws = narrow/wide, rwn = narrow/wide, rds = pretty_crowded, then green_dur = avg
  r5 = np.fmin(road_width_lvl_nar, road_density_lvl_pc)
  r6 = np.fmin(road_width_lvl_wide, road_density_lvl_pc)
  # If rws = narrow, rwn = narrow, rds = crowded, rdn = not/little crowded/pretty_crowded, then green_dur = long
  ...
  # If rws = narrow/wide, rwn = narrow, rds = pretty_crowded, rdn = crowded/very crowded, then green_dur = avg
  ...
  # If rws = narrow, rwn = narrow/wide, rds = very crowded, rdn = not/little/pretty_crowded, then green_dur = very long
  ...
  # If rws = narrow/wide, rwn = narrow, rds = very crowded, rdn = very crowded/crowded, then green_dur = long
  ...
  # If rws = narrow, rwn = wide, rds = very crowded, rdn = very crowded/crowded, then green_dur = very long
  ...
  # If rws = wide, rwn = narrow, rds = very crowded, rdn = very crowded/crowded, then green_dur = long 
  ...
  # If rws = wide, rwn = wide, rds = sangat podat/crowded, rdn = very crowded/crowded, then green_dur = long 
  ...
  # If rws = wide, rds = very crowded, rdn = not/little/pretty crowded, then green_dur = long
